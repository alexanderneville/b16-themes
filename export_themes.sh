...
b16_shell() {
    ...
    echo "fi"
    echo "put_template 0  $(add_slashes ${theme[0]})"
    ...
    echo "put_template 9  $(add_slashes ${theme[9]})"
    echo "put_template 10 $(add_slashes ${theme[1]})"
    echo "put_template 11 $(add_slashes ${theme[2]})"
    echo "put_template 12 $(add_slashes ${theme[4]})"
    echo "put_template 13 $(add_slashes ${theme[6]})"
    echo "put_template 14 $(add_slashes ${theme[15]})"
    echo "put_template 15 $(add_slashes ${theme[7]})"
